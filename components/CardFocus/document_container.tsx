...
const DocumentIcon = ({ document }: IDocumentProps) => {
  ...
  return (
    <div className="bordered rounded-lg bg-base-200/30 hover:bg-base-15 hover:text-base-content/25 p-2 pt-0 w-28 flex flex-col items-center text-center mb-4 relative">
      <div
      ...
      <div className="absolute rounded-lg z-10 w-full h-full flex items-center justify-center bg-neutral-content/50 opacity-0 hover:opacity-100">
        <EyeOpenIcon
