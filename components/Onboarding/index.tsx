      ...
      <div className="modal-box h-5/6 max-w-6xl flex flex-col">
        <ul className="steps w-full text-center mb-10">
          <li
            ...
            className={`step ${
              step > 0 ? "step-secondary cursor-pointer" : null
            }`}
          >
            Bienvenue !
          </li>
          <li
            ...
            className={`step ${
              step > 1 ? "step-secondary cursor-pointer" : null
            }`}
          >
            Mes favoris
          </li>
          <li
            ...
            className={`step ${
              step > 2 ? "step-secondary cursor-pointer" : null
            }`}
          >
            À éviter
          </li>
          <li
            className={`step ${
              step > 3 ? "step-secondary cursor-pointer" : null
            }`}
          >
            Résumé
          </li>
