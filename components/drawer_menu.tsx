        ...
        <div className="grow pt-3">
            ...
            <div className="form-control">
                ...
                <label className="label cursor-pointer">
                    ...
                    <input type="radio" name="colorScheme" value="timeTo" className="radio radio-primary"/>
                </label>
                <label className="label cursor-pointer">
                    <span className="label-text">Par groupe</span>
                    <input type="radio" name="colorScheme" value="group" className="radio radio-primary"/>
                </label>
            </div>
        </div>
